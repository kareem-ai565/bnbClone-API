...
namespace bnbClone_API
{
    ...
    .AddDefaultTokenProviders();
            ...
            // Authentication setup with JWT and Google
 ...
 .AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        ...
        OnMessageReceived = context =>
        {
            ...
            // Method 3: Check SignalR WebSocket query string
...
//                     policy.WithOrigins("http://localhost:4200", "https://localhost:4200")
            ...
            // Unit of Work and other services
            ...
            builder.Services.AddAutoMapper(cfg => {
                ...
                cfg.AddProfile<CancellationPolicyProfile>();
            });
            ...
            // Debug middleware for JWT debugging
